// Chat handler for Elmora wellness chatbot
...
function detectIntent(message: string): keyof typeof fallbackResponses {
...
router.post('/chat', async (req, res) => {
  try {
    const { message, currentMood, userPoints, userId }: ChatRequest = req.body;
